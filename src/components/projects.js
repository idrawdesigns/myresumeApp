...
class Projects extends Component {
  ...
  toggleCategories() {
    if (this.state.activeTab === 0) {
      return (
        <div className="projects-grid">
          ...
          <Card shadow={5} style={{ minWidth: '450', margin: 'auto' }}>
            ...
            <CardText>A 5day Nairobi Weather forecast app.</CardText>
            <CardActions border>
      ...
      return <div>this is React/Redux</div>;
    } else if (this.state.activeTab === 2) {
      return <div>this is Flutter</div>;
    } else if (this.state.activeTab === 2) {
      return <div>METEOR APOLLO</div>;
    }
  }
